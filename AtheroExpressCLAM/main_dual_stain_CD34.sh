#!/bin/bash
#
#SBATCH --job-name=DualStain_Train_CD34 # Job name
...
#SBATCH --output=/hpc/dhl_ec/VirtualSlides/DualStain/logs/%a.%j.%N.train_CD34.log # Log file
#SBATCH --error=/hpc/dhl_ec/VirtualSlides/DualStain/logs/%a.%j.%N.train_CD34.err # Error file
...
EVG_DATA_DIR="/hpc/dhl_ec/VirtualSlides/CD34"
CSV_DATA="/hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/merged_dataset_CD34.csv"
CSV_DATA_BAL="/hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/merged_dataset_balanced_CD34.csv"
SPLIT_DIR=" /hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/wsi_classification_binary_dual_stains_balanced_dual_stains_CD34_100_k10"
...
CUDA_VISIBLE_DEVICES=0 python main_dual_CD34.py \
...
--lr 1e-4 \
--label_frac 1.0 \
--exp_code CD34_IPH_classification_sb_noinst_k10_transfer_dual_eq \
