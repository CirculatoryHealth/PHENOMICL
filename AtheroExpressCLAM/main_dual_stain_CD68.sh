#!/bin/bash
#
#SBATCH --job-name=DualStain_Train_CD68 # Job name
...
#SBATCH --output=/hpc/dhl_ec/VirtualSlides/DualStain/logs/%a.%j.%N.train_CD68.log # Log file
#SBATCH --error=/hpc/dhl_ec/VirtualSlides/DualStain/logs/%a.%j.%N.train_CD68.err # Error file
...
EVG_DATA_DIR="/hpc/dhl_ec/VirtualSlides/CD68"
CSV_DATA="/hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/merged_dataset_CD68.csv"
CSV_DATA_BAL="/hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/merged_dataset_balanced_CD68.csv"
SPLIT_DIR=" /hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/wsi_classification_binary_dual_stains_balanced_dual_stains_CD68_100_k10"
...
CUDA_VISIBLE_DEVICES=0 python main_dual_CD68.py \
...
--lr 1e-4 \
--label_frac 1.0 \
--exp_code CD68_IPH_classification_sb_noinst_k10_transfer_dual_eq \
