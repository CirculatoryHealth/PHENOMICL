#!/bin/bash
#
#SBATCH --job-name=DualStain_Train_CD66b # Job name
...
#SBATCH --output=/hpc/dhl_ec/VirtualSlides/DualStain/logs/%a.%j.%N.train_CD66b.log # Log file
#SBATCH --error=/hpc/dhl_ec/VirtualSlides/DualStain/logs/%a.%j.%N.train_CD66b.err # Error file
...
EVG_DATA_DIR="/hpc/dhl_ec/VirtualSlides/CD66b"
CSV_DATA="/hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/merged_dataset_CD66b.csv"
CSV_DATA_BAL="/hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/merged_dataset_balanced_CD66b.csv"
SPLIT_DIR=" /hpc/dhl_ec/VirtualSlides/Projects/CONVOCALS/AtheroExpressCLAM/wsi_classification_binary_dual_stains_balanced_dual_stains_CD66b_100_k10"
...
CUDA_VISIBLE_DEVICES=0 python main_dual_CD66b.py \
...
--lr 1e-4 \
--label_frac 1.0 \
--exp_code CD66b_IPH_classification_sb_noinst_k10_transfer_dual_eq \
